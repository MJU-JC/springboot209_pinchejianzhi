	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"rgba(111, 111, 151, 1)","headFontSize":"24px","headUserInfoFontColor":"rgba(111, 111, 151, 1)","headBoxShadow":"0px 0px 0px 10px rgba(111,111,151,1) inset","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"rgba(111, 111, 151, 0.3)","headFontColor":"rgba(111, 111, 151, 1)","headTitleImg":false,"headHeight":"80px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"#e9f7ff","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"rgba(111, 111, 151, 1)","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"2","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()
