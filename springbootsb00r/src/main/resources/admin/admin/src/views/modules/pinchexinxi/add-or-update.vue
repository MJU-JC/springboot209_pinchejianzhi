<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出发地点" prop="chufadidian">
          <el-input v-model="ruleForm.chufadidian" 
              placeholder="出发地点" clearable  :readonly="ro.chufadidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出发地点" prop="chufadidian">
              <el-input v-model="ruleForm.chufadidian" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="到达地点" prop="daodadidian">
          <el-input v-model="ruleForm.daodadidian" 
              placeholder="到达地点" clearable  :readonly="ro.daodadidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="到达地点" prop="daodadidian">
              <el-input v-model="ruleForm.daodadidian" 
                placeholder="到达地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="单人费用" prop="danrenfeiyong">
          <el-input v-model="ruleForm.danrenfeiyong" 
              placeholder="单人费用" clearable  :readonly="ro.danrenfeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="单人费用" prop="danrenfeiyong">
              <el-input v-model="ruleForm.danrenfeiyong" 
                placeholder="单人费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="拼车金额" prop="pinchejine">
            <el-input v-model="pinchejine"
                placeholder="拼车金额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.pinchejine" label="拼车金额" prop="pinchejine">
              <el-input v-model="ruleForm.pinchejine" 
                placeholder="拼车金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="拼车时间" prop="pincheshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.pincheshijian" 
                type="datetime"
                :readonly="ro.pincheshijian"
                placeholder="拼车时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.pincheshijian" label="拼车时间" prop="pincheshijian">
              <el-input v-model="ruleForm.pincheshijian" 
                placeholder="拼车时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    ...
    pinchejine:{
      get: function () {
        return 1*this.ruleForm.danrenfeiyong*this.ruleForm.zuoweishu
      }
    },

  },
  created() {
	this.ruleForm.pincheshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chufadidian = true;
          ...
          if(o=='daodadidian'){
            this.ruleForm.daodadidian = obj[o];
	    this.ro.daodadidian = true;
            continue;
          }
          if(o=='chufashijian'){
	    ...
	    this.ro.chufashijian = true;
          ...
          if(o=='danrenfeiyong'){
            this.ruleForm.danrenfeiyong = obj[o];
	    this.ro.danrenfeiyong = true;
            continue;
          }
          if(o=='zuoweishu'){
	    ...
	    this.ro.zuoweishu = true;
          ...
          if(o=='pinchejine'){
            this.ruleForm.pinchejine = obj[o];
	    this.ro.pinchejine = true;
            continue;
          }
          if(o=='pincheshijian'){
        ...
        this.ruleForm.zuoweishu = 0
	    this.ro.zuoweishu = false;
      }
      // 获取用户信息
      this.$http({
    ...
    // 提交
    onSubmit() {
        this.ruleForm.pinchejine = this.pinchejine
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.zuoweishu = objcross.zuoweishu - this.ruleForm.zuoweishu
	      if(objcross.zuoweishu<0){
		this.$message.error("座位数不足");
		return
	      }
                }
	      this.$http({
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `pinchexinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.pinchexinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
