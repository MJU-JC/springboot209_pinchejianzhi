    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="兼职详情" prop="jianzhixiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jianzhixiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianzhixiangqing" label="兼职详情" prop="jianzhixiangqing">
                    <span v-html="ruleForm.jianzhixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gangweiyaoqiu = true;
          ...
          if(o=='jianzhixiangqing'){
            this.ruleForm.jianzhixiangqing = obj[o];
	    this.ro.jianzhixiangqing = true;
            continue;
          }
	...
	this.ruleForm.jianzhixiangqing = this.ruleForm.jianzhixiangqing.replace(reg,'../../../springbootsb00r/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
