<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="酬金" prop="choujin">
          <el-input v-model="ruleForm.choujin" 
              placeholder="酬金" clearable  :readonly="ro.choujin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="酬金" prop="choujin">
              <el-input v-model="ruleForm.choujin" 
                placeholder="酬金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接单账号" prop="jiedanzhanghao">
          <el-input v-model="ruleForm.jiedanzhanghao" 
              placeholder="接单账号" clearable  :readonly="ro.jiedanzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接单账号" prop="jiedanzhanghao">
              <el-input v-model="ruleForm.jiedanzhanghao" 
                placeholder="接单账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接单号码" prop="jiedanhaoma">
          <el-input v-model="ruleForm.jiedanhaoma" 
              placeholder="接单号码" clearable  :readonly="ro.jiedanhaoma"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接单号码" prop="jiedanhaoma">
              <el-input v-model="ruleForm.jiedanhaoma" 
                placeholder="接单号码" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fuwuleixing = true;
          ...
          if(o=='choujin'){
            this.ruleForm.choujin = obj[o];
	    this.ro.choujin = true;
            continue;
          }
          if(o=='yonghuzhanghao'){
	    ...
	    this.ro.jiedanshijian = true;
          ...
          if(o=='jiedanzhanghao'){
            this.ruleForm.jiedanzhanghao = obj[o];
	    this.ro.jiedanzhanghao = true;
            continue;
          }
          if(o=='jiedanhaoma'){
            this.ruleForm.jiedanhaoma = obj[o];
	    this.ro.jiedanhaoma = true;
            continue;
          }
        }
      }
      ...
      this.$http({
		...
		if(json.yonghuzhanghao!=''&&json.yonghuzhanghao){
                this.ruleForm.jiedanzhanghao = json.yonghuzhanghao
	    		this.ro.jiedanzhanghao = true;
		}
		if(json.shoujihaoma!=''&&json.shoujihaoma){
                this.ruleForm.jiedanhaoma = json.shoujihaoma
	    		this.ro.jiedanhaoma = true;
		}
        } else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `fuwujiedan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.fuwujiedanCrossAddOrUpdateFlag = false;
						 this.parent.search();
