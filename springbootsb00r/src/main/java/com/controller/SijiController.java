...
public class SijiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		SijiEntity user = sijiService.selectOne(new EntityWrapper<SijiEntity>().eq("sijizhanghao", username));
    ...
    public R register(@RequestBody SijiEntity siji){
    	...
    	SijiEntity user = sijiService.selectOne(new EntityWrapper<SijiEntity>().eq("sijizhanghao", siji.getSijizhanghao()));
		if(user!=null) {
